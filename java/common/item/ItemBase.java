...
public class ItemBase extends Item{
	...
	{
		this.setUnlocalizedName("sg."+name);
	...
	public void registerIcons(IIconRegister ir)
	{
		if(getSubNames()!=null)
			for(int i=0;i<icons.length;i++)
				this.icons[i] = ir.registerIcon("simplygenerators:"+itemName+"_"+getSubNames()[i]);
		else
			this.icons[0] = ir.registerIcon("simplygenerators:"+itemName);
	}
	@Override
	@SideOnly(Side.CLIENT)
