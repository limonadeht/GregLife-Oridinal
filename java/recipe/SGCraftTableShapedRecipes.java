...
public class SGCraftTableShapedRecipes implements IRecipe{
	...
	public SGCraftTableShapedRecipes(int par1, int par2, ItemStack[] ArrayOfItemStack, ItemStack itemstack){
    ...
    public SGCraftTableShapedRecipes func_92100_c()
    {
