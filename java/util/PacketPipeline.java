...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractMessage> {

	private EnumMap<Side, FMLEmbeddedChannel>           channels;
    private LinkedList<Class<? extends AbstractMessage>> packets           = new LinkedList<Class<? extends AbstractMessage>>();
     ...
     */
    public boolean registerPacket(Class<? extends AbstractMessage> clazz) {
    ...
    protected void encode(ChannelHandlerContext ctx, AbstractMessage msg, List<Object> out) throws Exception {
        ...
        Class<? extends AbstractMessage> clazz = msg.getClass();
    ...
    protected void decode(ChannelHandlerContext ctx, FMLProxyPacket msg, List<Object> out) throws Exception {
        ...
        Class<? extends AbstractMessage> clazz = this.packets.get(discriminator);
        if (clazz == null) {
            throw new NullPointerException("No packet registered for discriminator: " + discriminator);
        }

        AbstractMessage pkt = clazz.newInstance();
    ...
    public void initialise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("RecallStones", this);
    }
    ...
    public void postInitialise() {
        ...
        Collections.sort(this.packets, new Comparator<Class<? extends AbstractMessage>>() {

            @Override
            public int compare(Class<? extends AbstractMessage> clazz1, Class<? extends AbstractMessage> clazz2) {
